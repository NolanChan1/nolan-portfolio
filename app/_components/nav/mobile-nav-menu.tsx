...
const MobileNavMenu: React.FC<MobileNavMenuProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={`${
          isOpen ? `${styles.activeHiddenBackground} block translate-x-0` : "hidden translate-x-64 shadow-none"
        } ${
          styles.hiddenBackgroundTransition
        } fixed right-0 top-0 z-10 flex h-[100vh] w-64 bg-off-white-100 dark:bg-light-black-900`}
      ></div>
