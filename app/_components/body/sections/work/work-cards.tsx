...
export const VosynCard = () => {
  return (
    <SectionCard>
      ...
      <CardParagraph addMargin="bottom">
        Contributed to the development of a content consumption platform and an AI chat assistant in an Agile
        development environment.
      </CardParagraph>
      <CardParagraph>
        Additionally, led 8 – 10 developers for ~3 months. Broke down and assigned tasks, guided and mentored team
        members, conducted code reviews, and presented progress updates to project stakeholders.
      </CardParagraph>
    </SectionCard>
  );
};
