  ...
  return (
    <div className="relative h-max w-full">
      ...
      <button
        ...
        disabled={expandFunction === undefined || (disabled !== undefined && disabled === true)}
        aria-expanded={expanded}
        className={`${
          expandFunction !== undefined && "section-container transition-transform"
      ...
      >
        ...
        <div
          className={`${expandFunction !== undefined && (expanded ? "expanded-hover-chevron" : "hover-chevron")} ${
